package inky.app.managers
{
	...
	import inky.binding.Binding;
	import inky.binding.BindingManager;
	import inky.binding.events.PropertyChangeEvent;
	import inky.binding.events.PropertyChangeEventKind;
	import inky.controls.NavButton;
	import inky.app.inky;
	import inky.app.inky_internal;
	import inky.app.event_listener;
	...
	import inky.loading.loaders.SoundLoader;
	import inky.loading.loaders.SWFLoader;
	import inky.loading.loaders.XMLLoader;
	import inky.async.actions.ActionGroup;
	import inky.async.actions.ActionSequence;
						...
						if (!className && (xml.namespace() == inky))
						{
							switch (xml.localName())
							{
								...
								case 'AnimatorAction':
									...
									break;
								case 'ActionGroup':
									className = 'inky.async.actions.ActionGroup';
									break;
								case 'ActionSequence':
									className = 'inky.async.actions.ActionSequence';
									break;
								case 'Section':
									break;
								case 'Model':
									...
									break;
								case 'NavButton':
									className = 'inky.controls.NavButton';
									break;
								case 'Array':
									obj = [];
									for each (child in xml.*)
