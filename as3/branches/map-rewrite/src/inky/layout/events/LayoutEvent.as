package inky.layout.events
{
	...
	public class LayoutEvent extends Event
	{
		 ...
		 *
		 */
	    public function LayoutEvent(type:String, bubbles:Boolean = true, cancelable:Boolean = false, property:String = null)
	    {
	    ...
	    {
	        return new LayoutEvent(this.type, this.bubbles, this.cancelable, this.property);
	    }
		...
		{
			return this.formatToString("LayoutEvent", "type", "bubbles", "cancelable", "property");
		}
