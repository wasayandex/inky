package inky.binding 
{
	...
	public class BindingManager
	{
		...
		{
// TODO: Figure out a way to move this to inky.utils.parseExpression (problem is reliance on _idMarkupObjects which should probably also be util)
			// Trim whitespace.
