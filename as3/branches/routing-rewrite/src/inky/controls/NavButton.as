package inky.controls 
{
	...
	/**
	 *
	 *  A basic implementation of the INavButton interface. This class
	 ...
	 *
	 */
	public class NavButton extends MovieClip implements INavButton
	{
		...
		/**
		 *	Creates an instance of the NavButton class.
		 */
