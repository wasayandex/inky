package inky.framework.display
{
     ...
     *
     * @eventType inky.framework.events.TransitionEvent.TRANSITION_FINISH
     *
     */
	[Event(name="transitionFinish", type="inky.framework.events.TransitionEvent")]
     ...
     *
     * @eventType inky.framework.events.TransitionEvent.TRANSITION_START
     *
     */
	[Event(name="transitionStart", type="inky.framework.events.TransitionEvent")]
