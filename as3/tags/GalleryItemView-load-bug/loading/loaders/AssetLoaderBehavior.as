...
trace("Behavior loading " + this._target.source)
		...
		{
if ((e.type == "complete") || (e.type == "ready"))
{
//trace("Behavior hears Loader's " + e.type.toUpperCase())
//trace("GraphicLoader dispatches " + e.type.toUpperCase())
}
...
//trace('loading ' + this.source)
try {this._target['getTheLoader']().unload();}catch(error){}
try
{
	this.close();
//	trace(':::: CLOSED ' + this._target['getTheLoader']().contentLoaderInfo.url)
}
catch (e:Error) {
//	trace(':::: COULD NOT CLOSE ' + this._target['getTheLoader']().contentLoaderInfo.url)
};
