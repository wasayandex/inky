...
// TODO: find position of descriptors more intelligently.
					ba.position = ba.length - 120;
					_crc32 = data.readUnsignedInt();
					_sizeCompressed = data.readUnsignedInt();
					_sizeUncompressed = data.readUnsignedInt();
					_sizeFilename = data.readUnsignedShort();
					...
					throw new Error("Need a byte array for data descriptors to work");
				}
			}
		}
