package inky.display
{
     ...
     *
     * @eventType inky.events.TransitionEvent.TRANSITION_FINISH
     *
     */
	[Event(name="transitionFinish", type="inky.events.TransitionEvent")]
     ...
     *
     * @eventType inky.events.TransitionEvent.TRANSITION_START
     *
     */
	[Event(name="transitionStart", type="inky.events.TransitionEvent")]
	...
	public interface ITransitioningObject extends IDisplayObject
	{
		 ...
		 * 
		 * @see inky.transitions.PlayFrameLabelAction
		 * @see #remove();
		 * 
		 */
