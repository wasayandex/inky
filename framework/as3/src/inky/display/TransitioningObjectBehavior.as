package inky.display
{
	 ...
	 * 
	 * @see inky.display.ITransitioningObject
	 * 
	...
	public class TransitioningObjectBehavior extends EventDispatcher
	{
		...
		/**
		 * @copy inky.display.ITransitioningObject#intro
		 */
		...
		/**
		 * @copy inky.display.ITransitioningObject#outro
		 */
		...
		/**
 		 * @copy inky.display.ITransitioningObject#state
		 */
		...
		/**
		 * @copy inky.display.ITransitioningObject#remove()
		 */
