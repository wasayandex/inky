package inky.core
{
	...
	import inky.managers.MarkupObjectManager;
	import inky.managers.NavigationManager;
...
*/
		...
		{
			this.loadManager.cancelFetchAsset(this, asset);
		}
...
/*
		...
		{
			this.loadManager.fetchAsset(this, asset, callback);
		}
		...
		{
			this.loadManager.fetchAssetNow(this, asset, callback);
		}
...
/*			if (owner)
		...
		{
			return this.master._loadManager;
		}
		...
		private function _removeProgressBarNow(pb:Object):void
		{
			...
			if (pb.parent)
			{
				...
				pb.addEventListener(Event.REMOVED_FROM_STAGE, function(e:Event)
				{
					e.target.removeEventListener(e.type, arguments.callee);
					section.dispatchEvent(new Event('removeProgressBarComplete'));
				});
